...
CREATE INDEX idx_medics_time_slots_room_id ON centre_time_slots (room_id);
CREATE INDEX idx_medics_time_medic_calendar_id ON centre_time_slots (medic_calendar_id);